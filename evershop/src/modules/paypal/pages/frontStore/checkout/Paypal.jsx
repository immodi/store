...
export function Paypal({
    ...
    useEffect(() => {
        if (order_Id === undefined) {
            _setOrder_Id(generateRandomString());
        }
    ...
    return (
        <PayPalScriptProvider
            options={{
                ...
                environment: "sandbox",
                clientId:
                    "ATGyBS0gD1uWp6r8obohW_lLAp4dsyD0L5P2PJjhugzY_eaJXC1tEClwUfZWj3wPfTSmehNL-U4gm51F",
            }}
        >
            <div>
                    ...
                    <PayPalButtons
                        createOrder={async () => {
                            try {
                                ...
                                throw err; // Propagate the error so that the SDK is aware
                            }
                        }}
                        onApprove={() => {
                            startLoading();
